...
export function HashIcon({ size = 14, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SettingsIcon({ size = 14, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GridIcon({ size = 14, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GlobeIcon({ size = 14, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CheckSquareIcon({ size = 15, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ChatIcon({ size = 15, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
